import { View, Text, Pressable, TouchableHighlight, TouchableOpacity,ToastAndroid } from 'react-native'
...
//   };
    ...
    <SafeAreaView style={{alignItems:'center',gap:0,padding:40,borderWidth:3,borderColor:'red',borderRadius:10,backgroundColor:'rgba(255, 255, 255, 0.34)'}}>
        ...
        style={{borderColor:'white',borderWidth:2,borderRadius:10,fontSize:20,fontWeight:500,marginBottom:14,width:280,backgroundColor:'rgba(255, 255, 255, 0.42)',color:'rgb(255, 0, 0)'}}
        />
        <TouchableOpacity
